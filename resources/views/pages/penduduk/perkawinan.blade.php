...
<div class="page-info container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Laporan Pencatatan Perkawinan</li>
        </ol>
    </nav>
</div>
<div class="main-wrapper container">
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Laporan Pencatatan Perkawinan Bulan <b id="selectedMonth"></b></h5>
                    ...
                    <div class="card-body" id="createForm">
                        <form>
                            <h5 class="text-center">Form Pencatatan Perkawinan</h5>
                            ...
                            <div class="col">
                                <div class="row justify-content-center">
                                    <div class="mb-3 col-4">
                                        ...
                                        <input class="form-control" type="text" id="no_buku_nikah" placeholder="No. Buku Nikah">
                                    </div>
                                    <div class="mb-3 col-4">
                                        <label class="form-label">Tanggal Nikah :</label>
                                        <input type="date" class="form-control" id="tanggal_nikah">
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <button type="submit" data-url="{{ route('buku-perkawinan.add') }}" class="btn btn-outline-primary addPerkawinan">Tambah</button>
                            </div>                                                
                        </form>
                    </div>
                    <!-- end of form tambah -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label class="form-label">No. Buku Nikah :</label>
                        <input class="form-control" type="text" id="edit_no_buku_nikah" placeholder="No. Buku Nikah">
                    </div>
                    <div class="form-group col-md-6">
                        <label class="form-label">Tanggal Nikah :</label>
                        <input type="date" class="form-control" id="edit_tanggal_nikah">
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(function () {
        var table = $('.data-table').DataTable({
            ...
            processing  : true,
            serverSide  : true,
            ajax: "/load-perkawinan/" + new Date().getMonth(),
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false},
                {data: 'perkawinan_nik', name: 'perkawinan_nik'},
                {data: 'perkawinan_nama', name: 'perkawinan_nama'},
                {data: 'nama_desa', name: 'nama_desa'},
                {data: 'perkawinan_tempat_lahir', name: 'perkawinan_tempat_lahir'},
                {data: 'perkawinan_tanggal_lahir', name: 'perkawinan_tanggal_lahir'},
                {data: 'perkawinan_tanggal_nikah', name: 'perkawinan_tanggal_nikah'},
                {data: 'perkawinan_buku_nikah', name: 'perkawinan_buku_nikah'},
        ...
        $("div.download").html(
            '<div class="text-center">'+
                '<a id="save_id" href="/save-perkawinan/'+$('#input_month').val()+'"><button type="button" class="btn btn-outline-danger rounded-pill py-2.5 my-1">Cetak / Simpan</button></a>'+
            '</div>'
        );

        $('.data-table').on('click','.edit_perkawinan',function(e){
            e.preventDefault();
            ...
            var edit_tanggal_nikah = $(this).data('tanggal_nikah');
            var edit_buku_nikah = $(this).data('buku_nikah');
            ...
            document.getElementById("edit_tanggal_nikah").value = edit_tanggal_nikah;
            document.getElementById("edit_no_buku_nikah").value = edit_buku_nikah;
        });

        $('.update').click(function(e){
            e.preventDefault();
            var uId = $('#edit_id').val();
            var url = "/buku-perkawinan/edit/" + uId;
            ...
            formData.set('uTanggal_nikah', $('#edit_tanggal_nikah').val());
            formData.set('uBuku_nikah', $('#edit_no_buku_nikah').val());
        ...
        $('.data-table').on('click','.delete_perkawinan',function(e){
            e.preventDefault();
            var id = $(this).data('id');
        ...
        $(document).ready(function() {
            $('.addPerkawinan').click(function(e){
                e.preventDefault();
                var url = $(this).data('url');
                var formData = new FormData()
                ...
                formData.append('no_buku_nikah', $('#no_buku_nikah').val());
                formData.append('tanggal_nikah', $('#tanggal_nikah').val());
    ...
    function getMonth(){
        ...
        y = $('#input_month').val();
        $('.data-table').DataTable().ajax.url("/load-perkawinan/" + y).load();
        document.getElementById("save_id").href = "/save-perkawinan/"+y
