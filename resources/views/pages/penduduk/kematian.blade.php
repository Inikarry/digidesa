...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("div.download").html(
            '<div class="text-center">'+
                '<a id="save_id" href="/save-kematian/'+$('#input_month').val()+'"><button type="button" class="btn btn-outline-danger rounded-pill py-2.5 my-1">Cetak / Simpan</button></a>'+
            '</div>'
        );
    ...
    function getMonth(){
        ...
        document.getElementById("save_id").href = "/save-kematian/"+y
